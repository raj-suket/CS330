...
int main(int argc, char* argv[]){
  ...
  14:	354080e7          	jalr	852(ra) # 364 <uptime>
  18:	84aa                	mv	s1,a0
  1a:	00000097          	auipc	ra,0x0
  1e:	34a080e7          	jalr	842(ra) # 364 <uptime>
  22:	45a9                	li	a1,10
  24:	02b5653b          	remw	a0,a0,a1
  28:	06400613          	li	a2,100
  2c:	02c5063b          	mulw	a2,a0,a2
  30:	02b4c5bb          	divw	a1,s1,a1
  34:	00000517          	auipc	a0,0x0
  38:	7e450513          	addi	a0,a0,2020 # 818 <malloc+0x11a>
  3c:	00000097          	auipc	ra,0x0
  40:	60a080e7          	jalr	1546(ra) # 646 <printf>
    exit(0);
  44:	4501                	li	a0,0
  46:	00000097          	auipc	ra,0x0
  4a:	286080e7          	jalr	646(ra) # 2cc <exit>
        printf("Warning: No argument expected with uptime\n");
  4e:	00000517          	auipc	a0,0x0
  52:	79a50513          	addi	a0,a0,1946 # 7e8 <malloc+0xea>
  56:	00000097          	auipc	ra,0x0
  5a:	5f0080e7          	jalr	1520(ra) # 646 <printf>
  5e:	bf4d                	j	10 <main+0x10>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b4:	4e850513          	addi	a0,a0,1256 # 898 <digits>
 3b8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 474:	3d0c8c93          	addi	s9,s9,976 # 840 <malloc+0x142>
 ...
 482:	41ab8b93          	addi	s7,s7,1050 # 898 <digits>
 ...
 5a8:	29498993          	addi	s3,s3,660 # 838 <malloc+0x13a>
        while(*s != 0){
 5ac:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 68a:	22a7b783          	ld	a5,554(a5) # 8b0 <freep>
 ...
 6b2:	00e6ea63          	bltu	a3,a4,6c6 <free+0x4a>
{
 ...
 6f4:	1cf73023          	sd	a5,448(a4) # 8b0 <freep>
}
 6f8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 74e:	16690913          	addi	s2,s2,358 # 8b0 <freep>
  if(p == (char*)-1)
 752:	5afd                	li	s5,-1
 754:	a895                	j	7c8 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 756:	00000797          	auipc	a5,0x0
 75a:	16278793          	addi	a5,a5,354 # 8b8 <base>
 75e:	00000717          	auipc	a4,0x0
 762:	14f73923          	sd	a5,338(a4) # 8b0 <freep>
 766:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 78a:	12a73523          	sd	a0,298(a4) # 8b0 <freep>
      return (void*)(p + 1);
